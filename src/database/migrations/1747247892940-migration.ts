...
export class Migration1747247892940 implements MigrationInterface {
    name = 'Migration1747247892940'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`events\` (\`event_id\` int NOT NULL AUTO_INCREMENT, \`title\` varchar(255) NOT NULL, \`description\` text NOT NULL, \`start_date\` datetime NOT NULL, \`end_date\` datetime NOT NULL, \`location\` varchar(255) NOT NULL, \`city\` varchar(100) NULL, \`price\` decimal(8,2) NOT NULL DEFAULT '0.00', \`created_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updated_at\` timestamp NULL ON UPDATE CURRENT_TIMESTAMP, \`is_premium\` tinyint NOT NULL DEFAULT '0', \`paid_amount\` decimal(10,2) NULL, \`payment_date\` datetime NULL, \`user_id\` int NULL, PRIMARY KEY (\`event_id\`)) ENGINE=InnoDB`);
